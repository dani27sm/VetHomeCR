...
export type DocumentType = 'FE' | 'TE' | 'NC' | 'MR'; // MR = Mensaje Receptor

export type SaleCondition = '01' | '02' | '03' | '04' | '99';
export type PaymentMethod = '01' | '02' | '03' | '04' | '05';
export type NCCode = '01' | '02' | '03';
export type AcceptanceStatus = '01' | '02' | '03'; // 01 Aceptado, 02 Aceptado Parcial, 03 Rechazado
...
export interface SupplierInvoice {
  ...
  acceptanceCode?: AcceptanceStatus;
