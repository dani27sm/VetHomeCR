...
type View = 'dashboard' | 'clients' | 'agenda' | 'billing' | 'inventory' | 'history' | 'settings' | 'client-portal' | 'messages' | 'saas-billing' | 'analytics';
    ...
    <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
      <aside className={`${isSidebarOpen ? 'w-72' : 'w-24'} bg-white border-r border-slate-200 flex flex-col transition-all duration-300 z-40 shadow-sm`}>
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto no-scrollbar">
          ...
          <NavItem icon={<BarChart3 size={20} />} label="Estadísticas / Analítica" view="analytics" />
